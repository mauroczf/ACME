...
<head>
    ...
    <link rel="shortcut icon" href="./imagens/acmefavicon.png">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST">
                            <div class="text-center mt-3 mb-4">
                                <img id="img" src="./imagens/logologin1.png"  class="imglogo">
                            </div>
                        ...
                        <a href="usuarios.php" class="logar"><strong>Volta para Usuários</strong></a>
                        </div>
                        </form>
                        ...
                        if (isset($_POST['email'])) {
                            ...
                            {
                                $u->conectar("bd_acme", "localhost", "root", "123");
